...
const styles = StyleSheet.create({
  ...
  duelCard: { backgroundColor: 'rgba(184,255,46,0.08)', borderWidth: 1, borderColor: 'rgba(184,255,46,0.28)', borderRadius: 20, padding: 16, marginBottom: 12 },
  ...
  inviteText: { color: '#0A0B0F', fontSize: 14.5, fontFamily: font.extrabold },
